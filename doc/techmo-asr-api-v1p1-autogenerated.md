...
- [techmo/asr/api/v1p1/asr.proto](#techmo_asr_api_v1p1_asr-proto)
    - [AgeRecognitionAlternative](#techmo-asr-api-v1p1-AgeRecognitionAlternative)
    - [AgeRecognitionConfig](#techmo-asr-api-v1p1-AgeRecognitionConfig)
    - [AgeRecognitionResult](#techmo-asr-api-v1p1-AgeRecognitionResult)
    - [Audio](#techmo-asr-api-v1p1-Audio)
    - [AudioConfig](#techmo-asr-api-v1p1-AudioConfig)
    - [GenderRecognitionAlternative](#techmo-asr-api-v1p1-GenderRecognitionAlternative)
    - [GenderRecognitionConfig](#techmo-asr-api-v1p1-GenderRecognitionConfig)
    - [GenderRecognitionResult](#techmo-asr-api-v1p1-GenderRecognitionResult)
    - [LanguageRecognitionAlternative](#techmo-asr-api-v1p1-LanguageRecognitionAlternative)
    - [LanguageRecognitionConfig](#techmo-asr-api-v1p1-LanguageRecognitionConfig)
    - [LanguageRecognitionResult](#techmo-asr-api-v1p1-LanguageRecognitionResult)
    - [ResultConfig](#techmo-asr-api-v1p1-ResultConfig)
    - [SpeechRecognitionAlternative](#techmo-asr-api-v1p1-SpeechRecognitionAlternative)
    - [SpeechRecognitionConfig](#techmo-asr-api-v1p1-SpeechRecognitionConfig)
    - [SpeechRecognitionConfig.ConfigFieldsEntry](#techmo-asr-api-v1p1-SpeechRecognitionConfig-ConfigFieldsEntry)
    - [SpeechRecognitionResult](#techmo-asr-api-v1p1-SpeechRecognitionResult)
    - [SpeechRecognitionWord](#techmo-asr-api-v1p1-SpeechRecognitionWord)
    - [StreamingConfig](#techmo-asr-api-v1p1-StreamingConfig)
    - [StreamingRecognizeRequest](#techmo-asr-api-v1p1-StreamingRecognizeRequest)
    - [StreamingRecognizeRequestConfig](#techmo-asr-api-v1p1-StreamingRecognizeRequestConfig)
    - [StreamingRecognizeRequestControlMessage](#techmo-asr-api-v1p1-StreamingRecognizeRequestControlMessage)
    - [StreamingRecognizeRequestData](#techmo-asr-api-v1p1-StreamingRecognizeRequestData)
    - [StreamingRecognizeResponse](#techmo-asr-api-v1p1-StreamingRecognizeResponse)
    - [StreamingRecognizeResult](#techmo-asr-api-v1p1-StreamingRecognizeResult)

    - [AudioConfig.AudioEncoding](#techmo-asr-api-v1p1-AudioConfig-AudioEncoding)
    - [StreamingRecognizeResult.ResultFinalizationCause](#techmo-asr-api-v1p1-StreamingRecognizeResult-ResultFinalizationCause)

    - [Asr](#techmo-asr-api-v1p1-Asr)

- [Scalar Value Types](#scalar-value-types)



<a name="techmo_asr_api_v1p1_asr-proto"></a>
...
<a name="techmo-asr-api-v1p1-AgeRecognitionAlternative"></a>
...
<a name="techmo-asr-api-v1p1-AgeRecognitionConfig"></a>
...
<a name="techmo-asr-api-v1p1-AgeRecognitionResult"></a>
...
| recognition_alternatives | [AgeRecognitionAlternative](#techmo-asr-api-v1p1-AgeRecognitionAlternative) | repeated | The confidence-ordered list of alternative recognition hypotheses. |
...
<a name="techmo-asr-api-v1p1-Audio"></a>
...
<a name="techmo-asr-api-v1p1-AudioConfig"></a>
...
<a name="techmo-asr-api-v1p1-GenderRecognitionAlternative"></a>
...
<a name="techmo-asr-api-v1p1-GenderRecognitionConfig"></a>
...
<a name="techmo-asr-api-v1p1-GenderRecognitionResult"></a>
...
| ----- | ---- | ----- | ----------- |
| error | [techmo.api.Status](#techmo-api-Status) |  | The recognition process status. It may communicate warnings. In case of an error hindering recognition, all other message fields should be left unset. |
| recognition_alternatives | [GenderRecognitionAlternative](#techmo-asr-api-v1p1-GenderRecognitionAlternative) | repeated | The confidence-ordered list of alternative recognition hypotheses. |
...
<a name="techmo-asr-api-v1p1-LanguageRecognitionAlternative"></a>
...
<a name="techmo-asr-api-v1p1-LanguageRecognitionConfig"></a>
...
<a name="techmo-asr-api-v1p1-LanguageRecognitionResult"></a>
...
| ----- | ---- | ----- | ----------- |
| error | [techmo.api.Status](#techmo-api-Status) |  | The recognition process status. It may communicate warnings. In case of an error hindering recognition, all other message fields should be left unset. |
| recognition_alternatives | [LanguageRecognitionAlternative](#techmo-asr-api-v1p1-LanguageRecognitionAlternative) | repeated | The confidence-ordered list of alternative recognition hypotheses. |
...
<a name="techmo-asr-api-v1p1-ResultConfig"></a>
...
<a name="techmo-asr-api-v1p1-SpeechRecognitionAlternative"></a>
...
| confidence | [float](#float) | optional | The confidence estimate, ranging from 0.0 to 1.0. Support for this feature is optional. |
| words | [SpeechRecognitionWord](#techmo-asr-api-v1p1-SpeechRecognitionWord) | repeated | The details of the transcript&#39;s words. Empty unless `enable_time_alignment` is `true` in the request&#39;s [`SpeechRecognitionConfig`](#SpeechRecognitionConfig). |
...
<a name="techmo-asr-api-v1p1-SpeechRecognitionConfig"></a>
...
| config_fields | [SpeechRecognitionConfig.ConfigFieldsEntry](#techmo-asr-api-v1p1-SpeechRecognitionConfig-ConfigFieldsEntry) | repeated | Deprecated. The additional advanced service-dependend configuration for its speech recognizer. It may be silently ignored. |
...
<a name="techmo-asr-api-v1p1-SpeechRecognitionConfig-ConfigFieldsEntry"></a>
...
<a name="techmo-asr-api-v1p1-SpeechRecognitionResult"></a>
...
| ----- | ---- | ----- | ----------- |
| error | [techmo.api.Status](#techmo-api-Status) |  | The recognition process status. It may communicate warnings. In case of an error hindering recognition, all other message fields should be left unset. |
| recognition_alternatives | [SpeechRecognitionAlternative](#techmo-asr-api-v1p1-SpeechRecognitionAlternative) | repeated | The confidence-ordered list of alternative recognition hypotheses. |
...
<a name="techmo-asr-api-v1p1-SpeechRecognitionWord"></a>
...
<a name="techmo-asr-api-v1p1-StreamingConfig"></a>
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeRequest"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| config | [StreamingRecognizeRequestConfig](#techmo-asr-api-v1p1-StreamingRecognizeRequestConfig) |  | The immutable initial configuration of the request. Must be sent once in the request&#39;s first message. |
| control_message | [StreamingRecognizeRequestControlMessage](#techmo-asr-api-v1p1-StreamingRecognizeRequestControlMessage) |  | The message controlling the processing flow of the request. May be sent multiple times except in the request&#39;s first message. |
| data | [StreamingRecognizeRequestData](#techmo-asr-api-v1p1-StreamingRecognizeRequestData) |  | The data contents of the request itself. May be sent multiple times except in the request&#39;s first message. |
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeRequestConfig"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| audio_config | [AudioConfig](#techmo-asr-api-v1p1-AudioConfig) |  | Part of the configuration for the request&#39;s audio content. |
| result_config | [ResultConfig](#techmo-asr-api-v1p1-ResultConfig) |  | Part of the configuration for the request&#39;s result form. |
| streaming_config | [StreamingConfig](#techmo-asr-api-v1p1-StreamingConfig) |  | Part of the configuration for the request&#39;s processing flow. |
| speech_recognition_config | [SpeechRecognitionConfig](#techmo-asr-api-v1p1-SpeechRecognitionConfig) |  | Part of the configuration for speech recognition. |
| age_recognition_config | [AgeRecognitionConfig](#techmo-asr-api-v1p1-AgeRecognitionConfig) |  | Part of the configuration for age recognition. |
| gender_recognition_config | [GenderRecognitionConfig](#techmo-asr-api-v1p1-GenderRecognitionConfig) |  | Part of the configuration for gender recognition. |
| language_recognition_config | [LanguageRecognitionConfig](#techmo-asr-api-v1p1-LanguageRecognitionConfig) |  | Part of the configuration for language recognition. |
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeRequestControlMessage"></a>
...
| give_response | [bool](#bool) | optional | The flag to allow the service to return a response. After receiving this message, the service remains in the "give response" state. Ignored when the service is already in the "give response" state. Mutually exclusive with the `hold_response` field. |
| hold_response | [bool](#bool) | optional | The flag to forbid the service from returning a response. After receiving this message, the service remains in the "hold response" state. Ignored when the service is already in the "hold response" state. Mutually exclusive with the `give_response` field. |
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeRequestData"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| audio | [Audio](#techmo-asr-api-v1p1-Audio) |  | Part of the audio to perform recognition on. |
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| result | [StreamingRecognizeResult](#techmo-asr-api-v1p1-StreamingRecognizeResult) |  | The combined recognition results for another part of the audio. |
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeResult"></a>
...
| result_finalization_cause | [StreamingRecognizeResult.ResultFinalizationCause](#techmo-asr-api-v1p1-StreamingRecognizeResult-ResultFinalizationCause) |  | The field indicating the cause of result finalization. For interim results, the service should leave the field as `UNSPECIFIED`. For final results, the service must set the field to a value other than `UNSPECIFIED`. |
| speech_recognition_result | [SpeechRecognitionResult](#techmo-asr-api-v1p1-SpeechRecognitionResult) |  | The speech recognition result for another part of the processed audio, new with each final result, updates with each interim one. To obtain a complete result for all processed audio, for each final result received, a client should pick one of the result&#39;s recognition alternatives and buffer it on its own. It must be omitted if speech recognition is disabled. |
| age_recognition_result | [AgeRecognitionResult](#techmo-asr-api-v1p1-AgeRecognitionResult) |  | The current age recognition result for all processed audio, updated with each final result. It may be omitted in an interim result and must be omitted if age recognition is disabled. |
| gender_recognition_result | [GenderRecognitionResult](#techmo-asr-api-v1p1-GenderRecognitionResult) |  | The current gender recognition result for all processed audio, updated with each final result. It may be omitted in an interim result and must be omitted if gender recognition is disabled. |
| language_recognition_result | [LanguageRecognitionResult](#techmo-asr-api-v1p1-LanguageRecognitionResult) |  | The current language recognition result for all processed audio, updated with each final result. It may be omitted in an interim result and must be omitted if language recognition is disabled. |
...
<a name="techmo-asr-api-v1p1-AudioConfig-AudioEncoding"></a>
...
<a name="techmo-asr-api-v1p1-StreamingRecognizeResult-ResultFinalizationCause"></a>
...
<a name="techmo-asr-api-v1p1-Asr"></a>
...
| ----------- | ------------ | ------------- | ------------|
| StreamingRecognize | [StreamingRecognizeRequest](#techmo-asr-api-v1p1-StreamingRecognizeRequest) stream | [StreamingRecognizeResponse](#techmo-asr-api-v1p1-StreamingRecognizeResponse) stream | Perform bidirectional streaming recognition. |
