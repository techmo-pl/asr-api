...
- [techmo/asr/api/dictation/asr.proto](#techmo_asr_api_dictation_asr-proto)
    - [Age](#google-cloud-speech-v1-Age)
    - [ConfigField](#google-cloud-speech-v1-ConfigField)
    - [Gender](#google-cloud-speech-v1-Gender)
    ...
    - [SpeechDurationConfig](#google-cloud-speech-v1-SpeechDurationConfig)
    ...
    - [SpeechDurationThresholdMode](#google-cloud-speech-v1-SpeechDurationThresholdMode)
...
<a name="techmo_asr_api_dictation_asr-proto"></a>
<p align="right"><a href="#top">Top</a></p>

## techmo/asr/api/dictation/asr.proto



<a name="google-cloud-speech-v1-Age"></a>
...
| ----- | ---- | ----- | ----------- |
| age | [int32](#int32) |  | The recognized age, in years. |
| confidence | [float](#float) |  | The confidence in [0, 1] range, where near 0 means &#39;unsure&#39; and near 1 means &#39;almost certain&#39;. |
...
<a name="google-cloud-speech-v1-ConfigField"></a>
...
<a name="google-cloud-speech-v1-Gender"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| gender | [string](#string) |  | The recognized gender label. |
| confidence | [float](#float) |  | The confidence in [0, 1] range, where near 0 means &#39;unsure&#39; and near 1 means &#39;almost certain&#39;. |
...
<a name="google-cloud-speech-v1-LatticeEdge"></a>
...
<a name="google-cloud-speech-v1-RecognitionAudio"></a>
...
<a name="google-cloud-speech-v1-RecognitionConfig"></a>
...
| speech_contexts | [SpeechContext](#google-cloud-speech-v1-SpeechContext) | repeated | [*Optional*] |
...
| config_fields | [ConfigField](#google-cloud-speech-v1-ConfigField) | repeated | [**Extension by Techmo**] [*Optional*] A means to provide additional configuration fields via request. |
| model | [string](#string) |  | [*Optional*][*Unused*] |
| use_enhanced | [bool](#bool) |  | [*Optional*][*Unused*] |
| speech_duration_gender_recognition | [SpeechDurationConfig](#google-cloud-speech-v1-SpeechDurationConfig) |  | [**Extension by Techmo**][*Optional*] Gender and age recognition parameters |
| speech_duration_age_recognition | [SpeechDurationConfig](#google-cloud-speech-v1-SpeechDurationConfig) |  | [**Extension by Techmo**][*Optional*] Gender and age recognition parameters |
...
<a name="google-cloud-speech-v1-RecognitionLattice"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| final_nodes | [int32](#int32) | repeated | List of final nodes. |
| edges | [LatticeEdge](#google-cloud-speech-v1-LatticeEdge) | repeated | List of lattice edges. |
...
<a name="google-cloud-speech-v1-RecognizeRequest"></a>
...
<a name="google-cloud-speech-v1-RecognizeResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| results | [SpeechRecognitionResult](#google-cloud-speech-v1-SpeechRecognitionResult) | repeated | [*Output only*] Sequential list of transcription results corresponding to sequential portions of audio. |
...
<a name="google-cloud-speech-v1-SpeechContext"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| phrases | [string](#string) | repeated |  |
...
<a name="google-cloud-speech-v1-SpeechDurationConfig"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| speech_duration_threshold_mode | [SpeechDurationThresholdMode](#google-cloud-speech-v1-SpeechDurationThresholdMode) |  | The way in which service decides when to start recognition. |
| speech_duration_threshold_ms | [uint32](#uint32) |  | The minimum duration of speech in `audio` required to start recognition, in ms. Ignored, unless `speech_duration_threshold_mode` is `CUSTOM`. |
...
<a name="google-cloud-speech-v1-SpeechRecognitionAlternative"></a>
...
| words | [WordInfo](#google-cloud-speech-v1-WordInfo) | repeated | [*Output only*] A list of word-specific information for each recognized word. |
...
<a name="google-cloud-speech-v1-SpeechRecognitionResult"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| alternatives | [SpeechRecognitionAlternative](#google-cloud-speech-v1-SpeechRecognitionAlternative) | repeated | [*Output only*] May contain one or more recognition hypotheses (up to the maximum specified in `max_alternatives`). These alternatives are ordered in terms of accuracy, with the top (first) alternative being the most probable, as ranked by the recognizer. |
| lattice | [RecognitionLattice](#google-cloud-speech-v1-RecognitionLattice) | repeated | [**Extension by Techmo**] [*Output only*] Detailed recognition result (lattice). Returned only when requested (`ConfigField`: return-lattice=true in `RecognitionConfig` Message), only for final (`is_final = true`) results, and only when it&#39;s allowed by licence. When requested and not allowed by licence, [google.rpc.Code.FAILED_PRECONDITION] will be returned. |
| gender | [Gender](#google-cloud-speech-v1-Gender) |  | [**Extension by Techmo**] [*Output only*] Predicted gender of the speaker |
| age | [Age](#google-cloud-speech-v1-Age) |  | [**Extension by Techmo**] [*Output only*] Predicted age of the speaker |
...
<a name="google-cloud-speech-v1-StreamingRecognitionConfig"></a>
...
| start_input_timers | [bool](#bool) | optional | [**Extension by Techmo**] Another experimental feature from MRCPv2. https://www.rfc-editor.org/rfc/rfc6787.html#section-9.4.14 |
...
<a name="google-cloud-speech-v1-StreamingRecognitionResult"></a>
...
<a name="google-cloud-speech-v1-StreamingRecognizeRequest"></a>
...
| start_input_timers | [bool](#bool) |  | [**Extension by Techmo**] Another experimental feature from MRCPv2. https://www.rfc-editor.org/rfc/rfc6787.html#section-9.13 |
...
<a name="google-cloud-speech-v1-StreamingRecognizeResponse"></a>
...
| results | [StreamingRecognitionResult](#google-cloud-speech-v1-StreamingRecognitionResult) | repeated | [*Output only*] This repeated list contains zero or more results that correspond to consecutive portions of the audio currently being processed. It contains zero or one `is_final=true` result (the newly settled portion), followed by zero or more `is_final=false` results (the interim results). |
...
<a name="google-cloud-speech-v1-WordInfo"></a>
...
<a name="google-cloud-speech-v1-RecognitionConfig-AudioEncoding"></a>
...
<a name="google-cloud-speech-v1-SpeechDurationThresholdMode"></a>
...
| Name | Number | Description |
| ---- | ------ | ----------- |
| DEFAULT | 0 | Use an implementation-defined threshold value carefully tuned to obtain best results. |
| CUSTOM | 1 | Use an user-defined threshold value provided in the configuration message. |
| DISABLED | 2 | Disable early start of recognition and wait for the entire audio data. |



<a name="google-cloud-speech-v1-StreamingRecognitionResult-ResultFinalizationCause"></a>
...
<a name="google-cloud-speech-v1-StreamingRecognizeResponse-SpeechEventType"></a>
...
<a name="google-cloud-speech-v1-Speech"></a>
...
| ----------- | ------------ | ------------- | ------------|
| Recognize | [RecognizeRequest](#google-cloud-speech-v1-RecognizeRequest) | [RecognizeResponse](#google-cloud-speech-v1-RecognizeResponse) | Performs synchronous speech recognition: receive results after all audio has been sent and processed.

option (google.api.http) = { post: "/v1/speech:recognize" body: "*" }; |
| StreamingRecognize | [StreamingRecognizeRequest](#google-cloud-speech-v1-StreamingRecognizeRequest) stream | [StreamingRecognizeResponse](#google-cloud-speech-v1-StreamingRecognizeResponse) stream | Performs bidirectional streaming speech recognition: receive results while sending audio. This method is only available via the gRPC API (not REST). |
